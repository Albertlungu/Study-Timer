...
echo ""
echo "2️⃣  Start Everything (NEW!):"
echo "   Run both tracker and dashboard in one command:"
echo "   cd ~/Documents/GitHub/Study-Timer"
echo "   ./run.sh"
echo ""
echo "   OR start individually:"
echo ""
echo "3️⃣  Start the Tracker:"
echo "   Open a terminal and run:"
echo "   cd ~/Documents/GitHub/Study-Timer"
echo "   source venv/bin/activate"
echo "   python src/main.py"
echo ""
echo "4️⃣  Start the Dashboard:"
echo "   Open ANOTHER terminal and run:"
echo "   cd ~/Documents/GitHub/Study-Timer"
echo "   source venv/bin/activate"
echo "   python src/dashboard/app.py"
echo ""
echo "5️⃣  View Your Stats:"
